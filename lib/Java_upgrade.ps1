...
write-host -f yellow "  ChildView Utilities - Java Upgrade                 " -BackgroundColor Red
write-host -f yellow "  ===================================                " -BackgroundColor Red
...
$md5list = Import-Clixml -Path "$($package.path)\pack_jdk8.xml"
...
#$md5list | Export-Clixml -Path C:\gitroot\deploymentdev\package\pack_jdk8.xml
...
Upgrade_Java_JDK -software_pack:$md5list
